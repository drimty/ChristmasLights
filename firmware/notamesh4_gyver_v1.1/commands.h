...
// кнопка на пульте
#define IR_Key_Brightness_plus              0xFF5AA5  // >                   // Увеличить максимальную яркость 
#define IR_Key_Brightness_minus             0xFF10EF  // <                   // Уменьшить максимальную яркость 
#define IR_Key_Reset                        0xFF6897  // *                   // Сброс всех настроек и перезагрузка 
#define IR_Key_Demo                         0xFF22DD  // 4                   // Включит демо режим (перебор) 
#define IR_Key_Demo_Random                  0xFF02FD  // 5                   // Включит демо режим (Случайно) 
#define IR_Key_Demo_MyMode                  0xFFC23D  // 6                   // Включит демо режим (перебор) 
#define IR_Key_Demo_MyMode_Random           0xFFE01F  // 7                   // Включит демо режим (Случайно) 
//
...
//
#define IR_Key_Glitter                      0xFFA25D  // 1                   // Включить/выключить сверкание
#define IR_Key_BackGround                   0xFF629D  // 2                   // Включить/выключить заполнение фона
#define IR_Key_Candle                       0xFFE21D  // 3                   // Включить/выключить свечки
//
#define IR_Key_Previous_mode                0xFF4AB5  // Down                // Предыдущий эффект. Отключает демонстрационный режим
#define IR_Key_Next_mode                    0xFF18E7  // Up                  // Следующий эффект. Отключает демонстрационный режим
#define IR_Key_Onoff                        0xFF38C7   // OK                 // Вкл / Выкл
...
//
#define IR_Key_Mode_0                       0xFF9867 // 0                                   //  Эффект 0
...
#define IR_Key_Solid_Red                    0xFFA857  // 8                     //  Установить цвет Красный
...
#define IR_Key_Solid_White                  0xFF906F  // 9                   //  Установить цвет Белый

//#define IR_Key_Onoff                        0x40FF20DF   // OK                 // Вкл / Выкл
